...
class Ec2(Agent):
    ...
    def create_key_pair(self,
        ec2_client: Any,
        key_name: str,
        directory: Path = Path(os.path.expanduser("~/.cloudrun"))
    ) -> Optional[Path]:
        """
    ...
    def create_instance(self,
        ...
        try:
            ...
            # Log prefix
            log_prefix = f"{cloudrun.ui.AGENT_EVENT}{instance_name}{cloudrun.ui.AGENT_WHICH_BUILD}[build]{cloudrun.ui.RESET}"  # noqa: E501
            ...
            log_instance_id_template = f"{cloudrun.ui.MAGENTA}{{instance_id}}{cloudrun.ui.RESET}"  # noqa: E501
    ...
    def delete(self):
        ...
        if self.security_group_id is None:
            ...
            log_security_group_id = f"{cloudrun.ui.MAGENTA}{self.security_group_id}{cloudrun.ui.RESET}"  # noqa: E501
            while True:
                try:
                    self.ec2_client.delete_security_group(
